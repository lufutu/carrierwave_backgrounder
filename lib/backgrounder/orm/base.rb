  ...
  module Backgrounder
    module ORM
      ...
      module Base
        ...
        ##
        # User#process_in_background will process and create versions
        ...
        # end
        #
        # The above adds a User#process_upload method which can be used
        # at times when you want to bypass background
        # storage and processing.
        #
        #   @user.process_avatar = true
        #   @user.save
        #
        # You can also pass in your own workers using the second argument
        # in case you need other things done during processing.
        #
        #   class User < ActiveRecord::Base
        #     mount_uploader :avatar, AvatarUploader
        ...
        #   end
        #
        # In addition you can also add a column to the database appended
        # by _processing with a type of boolean which can be used to
        ...
        ##
        # #store_in_background  will process, version and store uploads
        # in a background process.
        #
        # class User < ActiveRecord::Base
        #   mount_uploader :avatar, AvatarUploader
        ...
        # end
        #
        # The above adds a User#process_<column>_upload method which
        # can be used at times when you want to bypass
